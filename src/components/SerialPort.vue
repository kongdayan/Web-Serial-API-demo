      ...
      <div class="col-span-1 mt-4">
        <div class="connection-settings mb-4">
          ...
          <div class="mb-4 flex">
            ...
            >
              <option
                v-for="optionBaudRate in baudRateOptionList"
                :key="optionBaudRate"
          ...
          <div class="mb-4 flex">
            ...
            >
              <option
                v-for="optionDataBit in dataBitOptionList"
                :key="optionDataBit"
                :value="optionDataBit"
              >
                {{ optionDataBit }}
          ...
          <div class="mb-4 flex">
            ...
            >
              <option
                v-for="optionStopBit in stopBitOptionList"
                :key="optionStopBit"
                :value="optionStopBit"
              >
                {{ optionStopBit }}
      ...
      <div class="col-span-5">
        <div class="grid grid-cols-5 gap-4 mb-4">
          ...
          >
            ...
            >
            <div
              v-if="!attribute.method.includes('set')"
              class="mb-2 h-6 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded py-2 px-3"
            >
              {{ attribute.value }}
            </div>
            <input
              v-if="attribute.method.includes('set')"
              :type="attribute.setParams.inputType"
              class="mb-2 h-6 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded py-2 px-3"
              v-model="attribute.value"
              :min="attribute.setParams.minValue"
              :max="attribute.setParams.maxValue"
        ...
        <div class="data-receive mb-4">
          ...
          <textarea
            id="receivedData"
            readonly
            class="mt-1 block w-full h-32 py-2 px-3 border border-gray-300 darl:border-gray-600 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"
            >{{ receivedData }}</textarea
          >
        </div>
      </div>
    </div>
    ...
    parsePayload(line) {
      ...
      if (line.startsWith("{")) {
        ...
        if (match) {
          ...
          this.updateAttributeValue("WiFi配置信息", ssid + "," + pwd);
        }
